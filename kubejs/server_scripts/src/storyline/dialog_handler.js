function printDialogueOverlay(player, speaker)
{
    ...
    player.paint({
        radioBG: {
            ...
            h: 48,
            color: '#FFFFFF',
            texture: 'kubejs:textures/dialog/dialogue_overlay.png',
            texture: 'kubejs:textures/item/fredeggs.png',
            alignX: 'left',
            alignY: 'top',
            draw: 'ingame'
        }
    ...
    player.paint({
        radioDialogue: {
            ...
            h: 76,
            color: '#FFFFFF',
            texture: 'kubejs:textures/dialog/dialogue_overlay_dialoguebox.png',
            alignX: 'left',
            alignY: 'top',
            draw: 'ingame'
        },
...
PlayerEvents.tick(event => {
    ...
    {
        printDialogueOverlay(player, 'Fred Eggs');
    }
    else
    {
...
// ItemEvents.rightClicked("kubejs:contract", event => {
//     const player = event.player;
